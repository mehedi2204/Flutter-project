...
class Button{
  ...
  Button(this.value, this.bgColor, this.fgColor);
    ...
    List<Button> buttons=[
      Button("C",   const Color(0xff33e53c).withOpacity(0.6),   Colors.white),
      Button("+/-", const Color(0xffd104f5).withOpacity(0.7),   Colors.white),
      Button("%",   const Color(0xff0372f9).withOpacity(0.7),   Colors.white),
      Button("/",   const Color(0xfff55b31).withOpacity(0.6),   Colors.white),
      ...
      Button("*",   const Color(0xff039a7c).withOpacity(0.6),    Colors.white),
      ...
      Button("-",   const Color(0xff3e039d).withOpacity(0.6),    Colors.white),
      ...
      Button("=",   const Color(0xfff70707).withOpacity(0.6),    Colors.white),
