             ...
             Row(
               ...
               children: [
                 Padding(
                   ...
                   child: Text(prev_result,style:  const TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.black54),),
                 ),
                 Padding(
                   padding: const EdgeInsets.symmetric(vertical: 5.0,horizontal: 18),
                   child: Text(selectedOperation,style:  const TextStyle(fontSize: 50,fontWeight: FontWeight.bold,color: Colors.black54),),
                 ),
               ],
             ),
             GestureDetector(
               ...
               child: Padding(
                ...
                child: Text(result,style: TextStyle(fontSize: result.length > 5 ? 50 : 80  ,fontWeight: FontWeight.bold,color: Colors.black54),),
            ),
             ),
             SizedBox(
